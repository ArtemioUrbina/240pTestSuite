	...
	while(!exit)
	{
		if(redraw)
		{
			...
			case HELP_PLUGE:
				...
				{
				case 1:
					VDP_drawTextBG(APLAN, "PLUGE (1/2)", TILE_ATTR(PAL1, 0, 0, 0), 13, 4);
					...
					break;
				case 2:
					VDP_drawTextBG(APLAN, "PLUGE (2/2)", TILE_ATTR(PAL1, 0, 0, 0), 13, 4);
			...
			case HELP_SOUND:
				...
				VDP_drawTextBG(APLAN, "in either channel or both.", TILE_ATTR(PAL0, 0, 0, 0), 4, y++);
				y++;
