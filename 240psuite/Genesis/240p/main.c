...
{ 
    ...
    while(!done)
    {
        ...
        pos = 6;
				VDP_drawTextBG(APLAN, "Plunge", TILE_ATTR(cursel == 1 ? PAL1 : PAL0, 0, 0, 0), 5, pos++);
...
void SoundTest()
{
    ...
    while(!exit)
    {
				...
				VDP_drawTextBG(APLAN, "Sound Test", TILE_ATTR(PAL0, 0, 0, 0), 15, 6);
    		VDP_drawTextBG(APLAN, "Left Channel", TILE_ATTR(sel == 0 ? PAL2 : PAL0, 0, 0, 0), 6, 12);
