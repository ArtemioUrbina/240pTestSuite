...
huc -DCDROM -DCDROM1 -DEXT_TOOLS -s -msmall -t -O2 -cd -overlay patterns_ext.c font.c video.c tools.c help.c float.c || goto :error
huc -DCDROM -DCDROM1 -DEXT_TOOLS -s -msmall -t -O2 -cd -overlay tests_ext.c video.c font.c tools.c help.c float.c  || goto :error
huc -DCDROM -DCDROM1 -s -msmall -t -O2 -cd -overlay tests_sound.c video.c font.c tools.c help.c || goto :error
