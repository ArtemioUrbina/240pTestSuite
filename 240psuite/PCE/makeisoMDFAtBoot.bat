...
pceas -DSCDROM -DCDROM -DMDF_AT_BOOT -s -msmall -scd -overlay loader.s  || goto :error
pceas -DSCDROM -DCDROM -DMDF_AT_BOOT -s -msmall -scd -overlay tests_reflex.s || goto :error
pceas -DSCDROM -DCDROM -DMDF_AT_BOOT -s -msmall -scd -overlay 240pSuite.s  || goto :error
