...
huc -DSCDROM -DCDROM -s -t -O2 -msmall -scd -overlay tests_manual.c help.c font.c video.c tools.c || goto :error
...
isolink 240pSuite.iso loader.ovl 240pSuite.ovl tests_manual.ovl adpcm.vox sweep.vox  || goto :error
