...
CALL makeclean.bat
huc -DSCDROM -s -t -O2 -msmall -scd -overlay loader.c font.c video.c
pceas -DSCDROM -s -msmall -scd -overlay loader.s
copy 240pSuite.c 240pArcade.c
huc -DSCDROM -s -t -O2 -msmall -scd -overlay 240pArcade.c font.c video.c tests.c patterns.c tools.c help.c 
pceas -DSCDROM -s -msmall -scd -overlay 240pArcade.s
