...
#asm
	...
	p_string	mdfourier_00_07,6,14
	p_string	mdfourier_00_08,6,16
	rts
...
mdfourier_00_05:	.db	"as generated by this system."
			.db	0
mdfourier_00_06:	.db	"You can press SELECT to run a clipping test which"
			.db	0
mdfourier_00_07:	.db	"runs all channels simultaneously."
			.db	0
mdfourier_00_08:	.db	"Visit http://junkerhq.net/MDFourier for details."
			.db	0
#endasm
}
...
smptecb_00_00:	.db	"SMPTE COLOR BARS"
			.db	0
smptecb_00_01:	.db	"- This pattern can be used to calibrate colors, but"
			.db	0
smptecb_00_02:	.db	"black level does not comply to the standard due"
			.db	0
smptecb_00_03:	.db	"to console capabilities."
			.db	0
smptecb_00_04:	.db	"- You can toggle between 75% and 100% SMPTE color"
			.db	0
smptecb_00_05:	.db	"bars by pressing I."
			.db	0
#endasm
}
