...
void display_consinter_00()
{
#asm
	p_string	consinter_00_00,22,4
	__ldwi		14
	call		_set_font_pal
	p_string	consinter_00_01,6,6
	p_string	consinter_00_02,6,7
	p_string	consinter_00_03,6,8
	p_string	consinter_00_04,6,9
	rts

consinter_00_00:	.db	"Audio Clipping"
			.db	0
consinter_00_01:	.db	"This test generates an audio signal that adds"
			.db	0
consinter_00_02:	.db	"several channels using harmonic frequencies in"
			.db	0
consinter_00_03:	.db	"order to create constructive interferance and "
			.db	0
consinter_00_04:	.db	"find if the resulting audio signal clips."
			.db	0
#endasm
}
