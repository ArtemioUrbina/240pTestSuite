...
N64_ROM_TITLE = "240p Test Suite" # Override this with the name of your game or project
N64_ROM_SAVETYPE = none # Supported savetypes: none eeprom4k eeprom16 sram256k sram768k sram1m flashram
N64_ROM_RTC = false # Set to true to enable the Joybus Real-Time Clock
N64_ROM_REGIONFREE = true # Set to true to allow booting on any console region
N64_ROM_REGION = 'A' # Set to a region code (emulators will boot on a specific console region)
...
N64_C_AND_CXX_FLAGS += -DN64 -O2 -Wall -Werror -Wno-error=deprecated-declarations 
